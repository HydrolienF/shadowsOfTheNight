...
public class Obstacle extends Image {
    private Body body;
    public Obstacle(String textureName, float x, float y, float width, float height) {
        super(new Texture("images/" + textureName + ".png"));
        createBody(x, y, width, height);
        body.setUserData(this);
        setBounds(x, y, width, height);
    }
    public Obstacle(float x, float y, float width, float height) { this(null, x, y, width, height); }
